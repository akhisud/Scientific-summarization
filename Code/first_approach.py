...
model.fit(X_train, y_train , batch_size=20, epochs=epochs, verbose = 1)
...
model.fit(X_tr, y_train, batch_size=10, epochs=20, verbose = 1)
y_pred = model.predict(X_te)
print("########### precision here #########",precision_recall_fscore_support(y_test, y_pred.round(), average='micro'))
